...
const steps = [
  {
    icon: CalendarPlus,
    title: "1. Book the Shoot",
    desc: "Create an event, set the date, and input client requirements in seconds."
  },
  {
    icon: Users,
    title: "2. Assign Crew",
    desc: "Select available photographers and editors. They get notified instantly."
  },
  {
    icon: Camera,
    title: "3. Reserve Gear",
    desc: "Check out equipment. The system ensures no double-booking occurs."
  },
  {
    icon: Send,
    title: "4. Deliver & Invoice",
    desc: "Track editing progress, send the final invoice, and close the job."
  }
]
