                        ...
                        {step === 2 && (
                            <div className="animate-in slide-in-from-right-4 fade-in duration-300 space-y-8">
                                <div className="space-y-1">
                                    ...
                                    <p className="text-slate-500">Packages within budget (LKR {consultation.requirements.budgetRange[1].toLocaleString()})</p>
                                </div>
                        ...
                        {step === 3 && (
                            <div className="animate-in slide-in-from-right-4 fade-in duration-300 space-y-8">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Textarea 
                                        placeholder="Add any specific promises, discounts discussd, or special notes..." 
